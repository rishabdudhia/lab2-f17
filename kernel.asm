...
80106d03:	e8 48 d4 ff ff       	call   80104150 <acquire>
  ...
  int found = 0;
  struct cpu* c = mycpu();
80106d08:	e8 03 c9 ff ff       	call   80103610 <mycpu>
  int i = 0; 
80106d0d:	31 d2                	xor    %edx,%edx
  struct cpu* c = mycpu();
80106d0f:	89 c7                	mov    %eax,%edi
  int a = PGROUNDUP(c->proc->sz);
80106d11:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80106d17:	8b 08                	mov    (%eax),%ecx
  pde_t* pgdir = c->proc->pgdir;
80106d19:	8b 40 04             	mov    0x4(%eax),%eax
  int a = PGROUNDUP(c->proc->sz);
80106d1c:	89 4d dc             	mov    %ecx,-0x24(%ebp)
80106d1f:	81 c1 ff 0f 00 00    	add    $0xfff,%ecx
80106d25:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
80106d28:	b9 f4 54 11 80       	mov    $0x801154f4,%ecx
  pde_t* pgdir = c->proc->pgdir;
80106d2d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  int firstZero = -1;
80106d30:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  int a = PGROUNDUP(c->proc->sz);
80106d35:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
80106d3c:	eb 17                	jmp    80106d55 <shm_open+0x65>
...
80106d40:	85 db                	test   %ebx,%ebx
80106d42:	75 06                	jne    80106d4a <shm_open+0x5a>
80106d44:	83 f8 ff             	cmp    $0xffffffff,%eax
80106d47:	0f 44 c2             	cmove  %edx,%eax
      firstZero = i;
    }
    ++i;
80106d4a:	83 c2 01             	add    $0x1,%edx
80106d4d:	83 c1 0c             	add    $0xc,%ecx
  while (i < 64) {
80106d50:	83 fa 40             	cmp    $0x40,%edx
80106d53:	74 73                	je     80106dc8 <shm_open+0xd8>
    if (id == shm_table.shm_pages[i].id) {
80106d55:	8b 19                	mov    (%ecx),%ebx
80106d57:	39 f3                	cmp    %esi,%ebx
80106d59:	75 e5                	jne    80106d40 <shm_open+0x50>
...
80106d5b:	8d 1c 52             	lea    (%edx,%edx,2),%ebx
80106d5e:	c1 e3 02             	shl    $0x2,%ebx
80106d61:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106d67:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d6e:	00 
80106d6f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d76:	00 
80106d77:	05 00 00 00 80       	add    $0x80000000,%eax
80106d7c:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80106d8d:	e8 be f7 ff ff       	call   80106550 <mappages>
    ++shm_table.shm_pages[id].refcnt;
80106d92:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
80106d99:	8b 87 ac 00 00 00    	mov    0xac(%edi),%eax
80106d9f:	8b 10                	mov    (%eax),%edx
  }
  *pointer = (char*)c->proc->sz;
80106da1:	8b 45 0c             	mov    0xc(%ebp),%eax
80106da4:	89 10                	mov    %edx,(%eax)
  c->proc->sz = c->proc->sz + PGSIZE;
80106da6:	8b 87 ac 00 00 00    	mov    0xac(%edi),%eax
80106dac:	81 00 00 10 00 00    	addl   $0x1000,(%eax)
  release(&(shm_table.lock));
80106db2:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106db9:	e8 82 d4 ff ff       	call   80104240 <release>
  return 0; //added to remove compiler warning -- you should decide what to return
}
80106dbe:	83 c4 2c             	add    $0x2c,%esp
...
80106dc8:	83 f8 ff             	cmp    $0xffffffff,%eax
80106dcb:	75 0b                	jne    80106dd8 <shm_open+0xe8>
80106dcd:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106dd0:	eb cf                	jmp    80106da1 <shm_open+0xb1>
80106dd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    shm_table.shm_pages[firstZero].id = id;
80106dd8:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106ddb:	c1 e3 02             	shl    $0x2,%ebx
80106dde:	89 b3 f4 54 11 80    	mov    %esi,-0x7feeab0c(%ebx)
    shm_table.shm_pages[firstZero].frame = kalloc();
80106de4:	e8 c7 b6 ff ff       	call   801024b0 <kalloc>
    memset(shm_table.shm_pages[firstZero].frame, 0, PGSIZE);
80106de9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106df0:	00 
80106df1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106df8:	00 
80106df9:	89 04 24             	mov    %eax,(%esp)
    shm_table.shm_pages[firstZero].frame = kalloc();
80106dfc:	89 83 f8 54 11 80    	mov    %eax,-0x7feeab08(%ebx)
    memset(shm_table.shm_pages[firstZero].frame, 0, PGSIZE);
80106e02:	e8 89 d4 ff ff       	call   80104290 <memset>
    mappages(pgdir, (char*)a, PGSIZE, V2P(shm_table.shm_pages[firstZero].frame), PTE_W|PTE_U);
80106e07:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
...
80106e33:	e8 18 f7 ff ff       	call   80106550 <mappages>
    shm_table.shm_pages[firstZero].refcnt = 1;
80106e38:	c7 83 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%ebx)
80106e3f:	00 00 00 
80106e42:	8b 87 ac 00 00 00    	mov    0xac(%edi),%eax
80106e48:	8b 10                	mov    (%eax),%edx
80106e4a:	e9 52 ff ff ff       	jmp    80106da1 <shm_open+0xb1>
80106e4f:	90                   	nop
...
80106e5d:	e8 ee d2 ff ff       	call   80104150 <acquire>
  int i = 0;
  int found = 0;
  while (i < 64) {
    if (id == shm_table.shm_pages[i].id) {
80106e62:	a1 f4 54 11 80       	mov    0x801154f4,%eax
80106e67:	39 45 08             	cmp    %eax,0x8(%ebp)
80106e6a:	75 2d                	jne    80106e99 <shm_close+0x49>
      id = i;
      break;
    }
  }
...
80106e6c:	a1 fc 54 11 80       	mov    0x801154fc,%eax
80106e71:	85 c0                	test   %eax,%eax
80106e73:	75 2b                	jne    80106ea0 <shm_close+0x50>
    else {
  ...
  release(&(shm_table.lock));
80106e75:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
      shm_table.shm_pages[id].id = 0;
80106e7c:	c7 05 f4 54 11 80 00 	movl   $0x0,0x801154f4
80106e83:	00 00 00 
      shm_table.shm_pages[id].frame = 0;
80106e86:	c7 05 f8 54 11 80 00 	movl   $0x0,0x801154f8
80106e8d:	00 00 00 
  release(&(shm_table.lock));
80106e90:	e8 ab d3 ff ff       	call   80104240 <release>
  return 0; //added to remove compiler warning -- you should decide what to return
}
80106e95:	31 c0                	xor    %eax,%eax
80106e97:	c9                   	leave  
80106e98:	c3                   	ret    
80106e99:	eb fe                	jmp    80106e99 <shm_close+0x49>
80106e9b:	90                   	nop
80106e9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      --shm_table.shm_pages[id].refcnt;
80106ea0:	83 e8 01             	sub    $0x1,%eax
  release(&(shm_table.lock));
80106ea3:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
      --shm_table.shm_pages[id].refcnt;
80106eaa:	a3 fc 54 11 80       	mov    %eax,0x801154fc
  release(&(shm_table.lock));
80106eaf:	e8 8c d3 ff ff       	call   80104240 <release>
}
80106eb4:	31 c0                	xor    %eax,%eax
80106eb6:	c9                   	leave  
80106eb7:	c3                   	ret    
